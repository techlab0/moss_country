...
export const Header: React.FC = () => {
  ...
  const navigationWithoutShop = links
  ...
  const navigation = [...navigationWithoutShop];
  if (showShopLink) {
    const homeIndex = navigation.findIndex(link => link.href === '/');
    navigation.splice(homeIndex >= 0 ? homeIndex + 1 : 0, 0, {
      name: shopLink.label || '商品',
      href: '/shop',
    });
  }
